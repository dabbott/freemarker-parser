...
export declare type AllParamTypes = Literal | ArrayExpression | Identifier | BinaryExpression | LogicalExpression | UnaryExpression | BuiltInExpression | MemberExpression | CallExpression | Compound | AssignmentExpression | UpdateExpression | MapExpression;
